...
Launch a background agent seeded with the summary: `claude --bg --name "<descriptive name>" "<handoff summary>"`. It starts in the current working directory and returns immediately; manage it with `claude agents`.
